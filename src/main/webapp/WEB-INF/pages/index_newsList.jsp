...
<section class="cid-qHNs2ZRU4F mbr-fullscreen" id="table1-r">

  <div class="container container-table text-white">
          ...
          <table class="table" cellspacing="0">
            ...
            <tbody>
				<tr> 
					...
					<td class="body-item mbr-fonts-style display-7">新聞標題1</td><td class="body-item mbr-fonts-style display-7">15</td><td class="body-item mbr-fonts-style display-7">2016-10-17</td>
				</tr>
				<tr>
					<td class="body-item mbr-fonts-style display-7">2</td>
					<td class="body-item mbr-fonts-style display-7">新聞標題2</td><td class="body-item mbr-fonts-style display-7">20</td><td class="body-item mbr-fonts-style display-7">2016-10-17</td>
				</tr>
			</tbody>
          </table>
        </div>
